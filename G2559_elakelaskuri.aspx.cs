...
public partial class G2559_elakelaskuri : System.Web.UI.Page
{
    const int MIN_IKA = 18;
    const int MAX_IKA = 63;
    int ika; //tämä appconfigista
    int palkka; // tämäkin appconfigista
    ...
    {
        Response.Redirect("~/G2559_elakelisatieto.aspx");
    }
