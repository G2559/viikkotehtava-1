...
public partial class G2559_Default2 : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("~/G2559_Valuuttamuunnin2.aspx?user=" + HttpUtility.UrlEncode(user.Text));
    }

    protected void btnSessio_Click(object sender, EventArgs e)
    {
        Session["user"] = HttpUtility.UrlEncode(user.Text);
        Response.Redirect("~/G2559_Valuuttamuunnin2.aspx");
    }
